...
extern "C" {
    ...
    #[link_name = "\u{1}?create@Lattice@MeCab@@SAPAV12@XZ"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?version@Model@MeCab@@SAPBDXZ"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?create@Model@MeCab@@SAPAV12@HPAPAD@Z"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?create@Model@MeCab@@SAPAV12@PBD@Z"]
...
extern "C" {
    ...
    #[doc = " }"]
    #[doc = " @return boolean"]
    #[link_name = "\u{1}?parse@Tagger@MeCab@@SA_NABVModel@2@PAVLattice@2@@Z"]
...
extern "C" {
    ...
    #[doc = " @param argc number of parameters"]
    #[doc = " @param argv parameter list"]
    #[link_name = "\u{1}?create@Tagger@MeCab@@SAPAV12@HPAPAD@Z"]
...
extern "C" {
    ...
    #[doc = " @return new Model object"]
    #[doc = " @param arg single string representation of the argment."]
    #[link_name = "\u{1}?create@Tagger@MeCab@@SAPAV12@PBD@Z"]
    pub fn MeCab_Tagger_create1(arg: *const ::std::os::raw::c_char) -> *mut MeCab_Tagger;
}
extern "C" {
    #[doc = " Return a version string"]
    #[doc = " @return version string"]
    #[link_name = "\u{1}?version@Tagger@MeCab@@SAPBDXZ"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?createLattice@MeCab@@YAPAVLattice@1@XZ"]
    pub fn MeCab_createLattice() -> *mut MeCab_Lattice;
}
extern "C" {
    #[doc = " Alias of Mode::create(argc, argv)"]
    #[link_name = "\u{1}?createModel@MeCab@@YAPAVModel@1@HPAPAD@Z"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?createModel@MeCab@@YAPAVModel@1@PBD@Z"]
    pub fn MeCab_createModel1(arg: *const ::std::os::raw::c_char) -> *mut MeCab_Model;
}
extern "C" {
    #[doc = " Alias of Tagger::create(argc, argv)"]
    #[link_name = "\u{1}?createTagger@MeCab@@YAPAVTagger@1@HPAPAD@Z"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?createTagger@MeCab@@YAPAVTagger@1@PBD@Z"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?deleteLattice@MeCab@@YAXPAVLattice@1@@Z"]
...
extern "C" {
    ...
    #[link_name = "\u{1}?deleteModel@MeCab@@YAXPAVModel@1@@Z"]
...
extern "C" {
    ...
    #[doc = " @return error string"]
    #[link_name = "\u{1}?getTaggerError@MeCab@@YAPBDXZ"]
